    ...
    <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-4 md:gap-6">
      {uploads.map((upload, index) => {
        ...
        return (
          ...
          >
            {/* Spooled Sync Indicator */}
            {upload.isSpooled && (
              <div className="absolute top-2.5 right-2.5 z-25 bg-orange-500/90 backdrop-blur-md px-2 py-0.5 rounded-md border border-orange-400 text-[8px] font-bold text-white tracking-widest animate-pulse flex items-center gap-1 shadow-lg">
